    ...
    <>
      <div
        ...
        style={{
          ...
          ...(isInMaintenance ? { boxShadow: `inset 0 0 0 12px ${statusColors.maintenance_needed}` } : {}),
        }}
        className={`
          ...
          ${compact ? `${largeFont ? 'text-base' : 'text-sm'} w-full h-full` : 'text-xs px-2 py-1 min-w-[2.5rem]'}
          ${isDragging ? 'z-50' : ''}
